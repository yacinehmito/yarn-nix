{ stdenv, fetchurl, fetchFromGitHub, unzip, buildPythonApplication, makeQtWrapper, wrapGAppsHook
, qtbase, pyqt5, jinja2, pygments, pyyaml, pypeg2, cssutils, glib_networking
, asciidoc, docbook_xml_dtd_45, docbook_xsl, libxml2, libxslt
, gst-plugins-base, gst-plugins-good, gst-plugins-bad, gst-plugins-ugly, gst-libav
, qtwebkit-plugins, qtwebengine }:
...
in buildPythonApplication rec {
  ...
  version = "0.9-2016-10-07";
  namePrefix = "";

  src = fetchFromGitHub {
    repo = "qutebrowser";
    owner = "The-Compiler";
    rev = "ea5cbb0c7f7d3ed68668ab3b62821e065f074615";
    sha256 = "14aik0v050xhxiyxjzjksiip3ir43vkgg2zkq4vayw61m3rmfgyg";
  };
